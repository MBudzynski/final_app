...
public class  WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    @Autowired
    private DataSource dataSource; // domyśle wstrzyknie aktualne źródło bazy danych

    @Autowired
    private PasswordEncoder passwordEncoder;

    // configuracja kontekstu spring seciurity
    // (jakie urle są chronione i na jakich działa mechanizm logowania)
...
//                .antMatchers("/products/").hasAnyAuthority(Role.ADMIN) //na dany url moga wejsc osoby zalogowane i z danym authority
                ...
                .antMatchers("/login", "/register", "/products").permitAll()//wpuszczamy wszystkich na dane urle
